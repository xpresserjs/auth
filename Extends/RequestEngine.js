 ...
 * @return {*}
 */
class AuthRequestEngine extends $.extendedRequestEngine() {
  /**
  ...
  isLogged() {
    ...
    */
    ...
    const keyAndValue = $.base64.decodeToObject(
        session.get('publicKey', {key: '', date: ''}));
...
module.exports = AuthRequestEngine;
